                  ...
                  <div class="row">
                    ...
                    <div class="input-group col-lg-6 mb-3">
                      ...
                      <input
                        ...
                        class="form-control bg-white border-left-0 border-md fileUploadButton"
                        className="form-control"
                    ...
                    >
                      {this.state.uploadMeter == 100
                        ? `Uploading Finished`
                        : this.state.uploadMeter
                        ? `Image Uploading : ${this.state.uploadMeter}%`
                        : ""}
                    </small>
